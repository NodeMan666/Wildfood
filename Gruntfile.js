...
module.exports = function (grunt) {
  ...
  grunt.registerTask('serve', function (target) {
    if (target === 'dist') {
      return grunt.task.run(['build', 'env:all', 'env:prod', 'express:prod', 'wait', 'open:server', 'express-keepalive']);
    }
  ...
  grunt.registerTask('build', [
    ...
    'useminPrepare',
    'autoprefixer',
    //'ngtemplates',  this doesnt work.... the template created are missing a lot of " and ' , breaks the whole app!!!!!
    //spend hours trying to figure out why the app doesnt work
    'html2js:appjs',
    'concat',
    //'ngAnnotate',
    'copy:dist'
